...
s_dot_rx = x_dot_M_B + d_m*theta_dot_M/2 - r*x(5);
...
F_x_fr = -mu_x*x(2)*(1-exp(-K*abs(s_dot_rx)/(1/2*(abs(s_dot_rx+r*x(5))+abs(r*x(5))+abs(abs(s_dot_rx+r*x(5))-abs(r*x(5)))))))*s_dot_rx/sqrt(s_dot_rx^2+s_dot_fy^2);
...
F_x_br = -mu_x*x(4)*(1-exp(-K*abs(s_dot_rx)/(1/2*(abs(s_dot_rx+r*x(5))+abs(r*x(5))+abs(abs(s_dot_rx+r*x(5))-abs(r*x(5)))))))*s_dot_rx/sqrt(s_dot_rx^2+s_dot_by^2);
